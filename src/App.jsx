...
const DEV_SCREENS = [
  ...
  { id: "m1kaart", label: "M1-R2 — kaart: kust of binnenland" },
  { id: "m1kaartmc", label: "M1-R2 — MC-controle" },
  { id: "m1r2", label: "M1-R3 — toestel naar gebied" },
  { id: "m1r2mc", label: "M1-R3 — MC-controle" },
  { id: "m1r3", label: "M1-R4 — belemmering" },
  { id: "m1r3mc", label: "M1-R4 — MC-controle" },
  { id: "tussen", label: "Tussenscherm" },
  { id: "m2intro", label: "Missie 2 — intro" },
  { id: "m2r1", label: "M2-R1 — waarom verdunnen?" },
  { id: "m2r1mc", label: "M2-R1 — MC-controle" },
  { id: "m2r2", label: "M2-R2 — de eis f < 0,01" },
  { id: "m2r2mc", label: "M2-R2 — MC-controle" },
  { id: "m2r3", label: "M2-R3 — combiketel 50%-regel" },
